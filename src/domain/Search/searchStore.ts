...
import { type BaseNodeProperty, CurrentCursorType, type LocationDTO, NodeData, SearchNodeData } from '@/model/types'
 ...
 */
//
export const nodeMetric = (node: TextNode, _count: number = 0) => {
	/** 화면에 보여지는 bounds */
...
class SearchStore {
	 ...
	 * @returns
	 */
	async search(ignoreSectionIds: string[] = [], _cacheCall: boolean = false) {
