...
import type { ResourceDTO, StyleSync } from '@/model/types'
...
import { NODE_STORE_KEY, VARIABLE_PREFIX } from '../constant'
import { generateLocalizationName, getLocalizationKeyData } from '../Label/TextPluginDataModel'
