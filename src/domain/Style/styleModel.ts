...
export const createStyleSegments = (characters: string, styleData: ValidAllStyleRangesType): StyleSegment[] => {
	// 1. 모든 범위의 시작점과 끝점 수집
	...
	for (let i = 0; i < sortedPoints.length - 1; i++) {
		...
		// 현재 구간의 스타일 계산
		const segmentStyle: Record<string, any> = { ...baseStyle }
