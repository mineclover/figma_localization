...
import { getCursorPosition, nodeMetaData } from '@/domain/getState'
import { getFrameNodeMetaData, type MetaData, searchStore, setFrameNodeMetaData } from '@/domain/Search/searchStore'
import {
	autoSelectNodeEmit,
	baseNodeCheck,
	getBackgroundFrame,
...
export const onNodeSelectionChange = () => {
	...
	const _metaDataStore = new Map<string, FrameNode>()
